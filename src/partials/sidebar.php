<aside class="sidebar" data-sidebar>
    <nav class="sidebar-nav">
        <!-- Аватарка вверху сайдбара -->
        <div class="sidebar-avatar-wrap" style="margin-bottom: 24px; display: flex; justify-content: center; width: 100%;">
            <div style="width: 72px; height: 72px; border-radius: 50%; background: #eef2f7; display: flex; align-items: center; justify-content: center;">
        ...
        <a href="/profile" class="nav-item <?= $active === 'profile' ? 'active' : '' ?>" title="Profile">
            <span class="nav-icon">
                <svg width="24" height="24" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="54" height="54" rx="27" fill="var(--color-bg-secondary)" />
                    <g clip-path="url(#clip0_45_319)">
                        <path d="M14.0226 42.9856H38.9774C40.8539 42.9856 42 42.0845 42 40.6254C42 35.8764 36.0549 29.3251 26.5 29.3251C16.945 29.3251 11 35.8764 11 40.6254C11 42.0845 12.146 42.9856 14.0226 42.9856ZM26.5143 26.0208C30.5111 26.0208 33.8632 22.4733 33.8632 17.896C33.8632 13.4187 30.4824 10 26.5143 10C22.5605 10 19.1797 13.4759 19.1797 17.9246C19.1797 22.4733 22.5319 26.0208 26.5143 26.0208Z" fill="#BFCFEF"/>
                    </g>
                    <defs><clipPath id="clip0_45_319"><rect width="31" height="33" fill="white" transform="translate(11 10)"/></clipPath></defs>
                </svg>
            </span>
            <span class="nav-text">Profile</span>
        </a>

        <a href="/foryou" class="nav-item <?= $active === 'for-you' ? 'active' : '' ?>" title="Feed">
            <span class="nav-icon">
        ...
        <a href="/library" class="nav-item <?= $active === 'library' ? 'active' : '' ?>" title="Library">
            <span class="nav-icon">
                <svg width="24" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/saved" class="nav-item <?= $active === 'saved' ? 'active' : '' ?>" title="Saved">
            <span class="nav-icon">
    ...
    <div class="sidebar-bottom">
        <a href="/settings" class="nav-item" title="More">
